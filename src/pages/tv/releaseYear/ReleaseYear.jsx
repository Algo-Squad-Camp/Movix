...
const ReleaseYear = () => {
    ...
    const { data, loading } = useFetch(`/discover/tv?first_air_date_year=${releaseYear}`);

    const title = releaseYear + " TV Shows List";
    ...
    return (
        <>
            <div className="carouselSection">
                <ContentWrapper>
                    <span className="carouselTitle" onClick={() => setShow(true)}>Release Year '{releaseYear}'</span>
